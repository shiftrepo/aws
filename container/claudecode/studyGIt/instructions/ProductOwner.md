...
4. **明確な指示**: ScrumMaster1に対して、プロジェクトの目的、ビジョン、成功基準を明確に伝達
5. **成果確認**: ScrumMaster1からの報告を受け、ユーザーへの価値提供を確認
...
## 指示を受けた時の実行手順
```bash
# 深い理解と戦略的な指示をScrumMaster1に送信
./agent-send.sh ScrumMaster1 "あなたはScrumMaster1です。
...
3. **完了まで繰り返し**
   ```bash
   # 不足がある場合の追加指示例
   ./agent-send.sh ScrumMaster1 "【追加作業依頼】
