...
This script also handles downloading Google Patents databases from S3.
"""
...
if __name__ == "__main__":
    ...
    # Download Google Patents database
    patents_success = download_google_patents_db()
    ...
    # If both downloads failed, exit with error
