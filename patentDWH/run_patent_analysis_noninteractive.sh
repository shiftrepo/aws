#!/bin/bash
# Non-interactive script to run patent analysis system standalone
# Usage: ./run_patent_analysis_noninteractive.sh "トヨタ" inpit

# Get command line arguments
APPLICANT_NAME="$1"
DB_TYPE="${2:-inpit}"

echo "===== Patent Analysis System: Non-Interactive Mode ====="
...
echo "===== Patent Analysis Completed with status $ANALYSIS_STATUS ====="
echo "Check the output directory: ../patent_analysis_container/output/"

# Automatically stop the supporting containers
